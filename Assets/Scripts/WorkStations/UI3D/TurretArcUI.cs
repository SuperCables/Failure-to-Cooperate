...
public class TurretArcUI : MonoBehaviour
{
    ...
    public void Refresh()
    {
        ...
        Vector2 left = InGame.DegreeToVector2(-halfAngle, length);
        Vector2 right = InGame.DegreeToVector2(halfAngle, length);
        ...
        {
            arcPoints[i] = InGame.DegreeToVector2(Mathf.Lerp(-halfAngle, halfAngle, i/ (pointCount - 1f)), length * curvePos) + correctionOffset;
        }
